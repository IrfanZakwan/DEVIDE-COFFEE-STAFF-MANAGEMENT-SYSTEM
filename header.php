               ...
               <!--header start here-->
				<div class="header-main">
					<div style="padding: 0em; margin-right: 0%; width: 70%;"  class="logo-w3-agile">
						<h1><a href="index.php">Welcome to DevideCafe Staff System<h5>For Employee From Management</h5></a></h1>
					</div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="image/DEVIDELOGO.png"<?php echo $_SESSION['User']['ImageName']?>" alt=""> </span> 
												<div class="user-name">
